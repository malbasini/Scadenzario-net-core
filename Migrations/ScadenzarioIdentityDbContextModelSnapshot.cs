...
namespace Scadenzario.Migrations
{
    ...
    partial class ScadenzarioIdentityDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Scadenzario.Models.Entities.Beneficiario", b =>
                {
                    ...
                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<int>("IdBeneficiario"));
            ...
            modelBuilder.Entity("Scadenzario.Models.Entities.Scadenza", b =>
                {
                    ...
                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<int>("IDScadenza"));
            ...
            modelBuilder.Entity("Scadenzario.Models.Entities.Subscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Scadenzario.Models.Entities.Subscription", b =>
                {
                    b.HasOne("Scadenzario.Models.Entities.Scadenza", "scadenze")
                        .WithMany()
                        .HasForeignKey("ScadenzaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Scadenzario.Models.Entity.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
